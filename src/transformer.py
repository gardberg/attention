...
class EncoderLayer:
    ...
    def __init__(self, emb_size: int, n_heads: int, d_ff: int=2048, dropout: float=0):
    ...
    def __call__(self, state: EncoderLayerState, x: jax.Array, mask: jax.Array, rng: jax.Array) -> jax.Array:
        """
